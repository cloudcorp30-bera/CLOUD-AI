...
const { imageToWebp, videoToWebp, writeExifImg, writeExifVid } = require('../lib/exif.cjs');
const { getBuffer, getSizeMedia } = require('../lib/myfunc.cjs');
...
module.exports = { decodeJid, serialize };
